-- schema-tidb.sql untuk UKM PSHT Landing Page (TiDB Cloud)
-- DB: ukmpsht, charset utf8mb4_unicode_ci
-- Diadaptasi dari schema.sql untuk TiDB Cloud Starter (MySQL-compatible, managed)
-- Catatan: database `ukmpsht` harus sudah dibuat via dashboard TiDB
